                ...
                <div className="row">
                        ...
                        <div className="card-box-c foo">
                            ...
                            <div className="card-body-c">
                                <p className="content-c">
                                    Sed porttitor lectus nibh. Cars ultricies ligula sed magna
                    ...
                    <div className="col-md-4">
                        <div className="card-box-c foo">
                            ...
                            <div className="card-body-c">
                                <p className="content-c">
                                    Nulla porttiroe accumsan tincidunt. Curabitur aliquet quam id
                                    dui posuere blandia. Mauris blandit aliquet elit, eget
                    ...
                    <div className="col-md-4">
                        <div className="card-box-c foo">
                            ...
                            <div className="card-body-c">
                                <p className="content-c">
                                    Sed porttiroe lectus nibh. Cras ultricies ligula sed magna
                                    dictum porta. Praesent sapien massa, concallis a pellentesque
                                    nec, egestas non nisi.
                                </p>
                            </div>
